...
│   └── beaglev-fire/      # BeagleV-Fire cape gateware + board tools
│       ├── gateware/
...
├── kat/                   # NIST Known Answer Test vectors (sha3/, mlkem768/, mldsa65/, aes_gcm/, drbg/)
├── scripts/               # run_kat.py, run_sp80022.py, gen_fw_header.py, integration_test.py, ota_demo.py, soak_test.py
├── tools/
